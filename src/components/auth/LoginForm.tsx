  ...
  return (
    ...
    >
      <div className="space-y-1 text-center">
        <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight bg-linear-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
          Login to Your Account
        </h2>
        <p className="text-xs md:text-sm text-zinc-500 dark:text-zinc-400">
          Enter your credentials to continue your tech journey
        </p>
      </div>
        ...
        <InputGroup className="h-12 border rounded-xl border-zinc-200 dark:border-zinc-800 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 bg-zinc-50/50 dark:bg-zinc-950/50 overflow-hidden transition-all duration-200">
          ...
          <InputGroup.Suffix className="pr-3 flex items-center bg-transparent">
            <Button
              ...
              size="sm"
              className="hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-lg text-zinc-500 bg-transparent"
      ...
      <div className="flex gap-2 pt-2">
        <Button
          type="submit"
          className="w-full h-12 text-sm font-semibold text-white bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-md shadow-indigo-600/20 rounded-md hover:rounded-3xl transition-all duration-300 active:scale-98 group"
        >
